...
pub(crate) const ON_VOICE_EVENT: usize = 0x68FD98;
...
pub(crate) const ON_AUDIOSYSTEM_PLAY: usize = 0x975FE4;
...
pub(crate) const ON_AUDIOSYSTEM_STOP: usize = 0x2440C30;
...
pub(crate) const ON_ENTITY_QUEUE_EVENT: usize = 0x5F4A18;
...
pub(crate) const ON_ICOMPONENT_QUEUE_ENTITY_EVENT: usize = 0xA07B74;
