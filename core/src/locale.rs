...
use audioware_sys::{error::ConversionError, interop::locale::Locale};
use red4ext_rs::types::CName;

/// locale currently used for e.g. subtitles and UI texts.
#[derive(Debug, Default, Clone, Copy)]
pub struct SpokenLocale(audioware_sys::interop::locale::Locale);

/// locale currently set for e.g. voices and dialogs.
#[derive(Debug, Default, Clone, Copy)]
pub struct WrittenLocale(audioware_sys::interop::locale::Locale);
