...
/// @pattern 48 89 5C 24 ? 48 89 74  24 ? 48 89 7C 24 ? 55  48 8B EC 48 83 EC ? 48  8B 02 48 8D 3D ? ? ?  ? FE 42 ? 4C 8D 45 ?  33 F6 45 33 C9 48 89 75  ? 48 8B DA 48 89 72 ?  48 89 72 ? 0F B6 08 48  FF C0 48 89 02 8B C1  48 8B 4A ? FF ? ? 48 8B  03 4C 8D 45 ? FE 43 ?  45 33 C9 48 89 75 ? 48  8B D3 48 89 73 ? 48 89  73 ? 0F B6 08 48 FF C0  48 89 03 8B C1 48 8B 4B  ? FF 14 C7 48 8B 03 4C  8D 45 ? FE 43 ? 45 33  C9 48 89 75 ? 48 8B D3  48 89 73 ? 48 89 73 ?  0F B6 08 48 FF C0 48 89  03 8B C1 48 8B 4B ? FF  14 C7 48 8B 03 4C 8D 45  ? FE 43 ? 45 33 C9 48  89 75 ? 48 8B D3 48 89  73 ? 48 89 73 ?
...
typedef void AudioSystem_Switch(void* aContext, void* aFrame, float* aOut, void* a4);
