...
impl SetControlledEq for Emitters {
    fn set_controlled_kind(&mut self, id: ControlId, kind: kira::effect::eq_filter::EqFilterKind) {
        self.entries.iter_mut().for_each(|mut x| {
            SetControlledEq::set_controlled_kind(x.value_mut(), id, kind);
        });
    }
...
impl SetControlledDistortion for Emitters {
    fn set_controlled_kind(
        ...
        self.entries.iter_mut().for_each(|mut x| {
            SetControlledDistortion::set_controlled_kind(x.value_mut(), id, kind);
        });
    }
    ...
    fn set_controlled_mix(&mut self, id: ControlId, mix: f32, tween: Tween) {
        self.entries.iter_mut().for_each(|mut x| {
            SetControlledDistortion::set_controlled_mix(x.value_mut(), id, mix, tween);
        });
    }
}

impl SetControlledDelay for Emitters {
    fn set_controlled_feedback(
        ...
        self.entries.iter_mut().for_each(|mut x| {
            SetControlledDelay::set_controlled_feedback(x.value_mut(), id, feedback, tween);
        });
    }

    fn set_controlled_mix(&mut self, id: ControlId, mix: f32, tween: Tween) {
        self.entries.iter_mut().for_each(|mut x| {
            SetControlledDelay::set_controlled_mix(x.value_mut(), id, mix, tween);
        });
    }
}

impl SetControlledCompressor for Emitters {
    ...
    fn set_controlled_mix(&mut self, id: ControlId, mix: f32, tween: Tween) {
        self.entries.iter_mut().for_each(|mut x| {
            SetControlledCompressor::set_controlled_mix(x.value_mut(), id, mix, tween);
        });
    }
}

impl SetControlledFilter for Emitters {
    ...
    fn set_controlled_mix(&mut self, id: ControlId, mix: f32, tween: Tween) {
        self.entries.iter_mut().for_each(|mut x| {
            SetControlledFilter::set_controlled_mix(x.value_mut(), id, mix, tween);
        });
    }
}

impl SetControlledReverb for Emitters {
    fn set_controlled_feedback(&mut self, id: ControlId, feedback: f32, tween: Tween) {
        self.entries.iter_mut().for_each(|mut x| {
            SetControlledReverb::set_controlled_feedback(x.value_mut(), id, feedback, tween);
        });
    }
    ...
    fn set_controlled_mix(&mut self, id: ControlId, mix: f32, tween: Tween) {
        self.entries.iter_mut().for_each(|mut x| {
            SetControlledReverb::set_controlled_mix(x.value_mut(), id, mix, tween);
        });
    }
}
